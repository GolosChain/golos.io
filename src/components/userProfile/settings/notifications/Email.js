        ...
        <form onSubmit={handleSubmit}>
              ...
              <Field name="a">
                {({ input }) => (
                  <FormGroupRow>
                    ...
                    <LabelRow dark>Включить/выключить все e-mail уведомления</LabelRow>
                    <Switcher {...input} />
                  </FormGroupRow>
                )}
              </Field>
          ...
          <CardContent column>
            <Field name="c">
              {({ input }) => (
                <FormGroupRow>
                  <LabelRow dark>Количество авторских и кураторских наград за день/неделю</LabelRow>
                  <Switcher {...input} />
                </FormGroupRow>
              )}
            </Field>
